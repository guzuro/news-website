...
const sourcePath = path.join(__dirname, './hcms-backend/types/generated/contentTypes.d.ts');
const destinationPath = path.join(__dirname, './client/types/contentTypes.d.ts');
